        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
            ...
            <ul class="navbar-nav collapse" id="collapseExample" style="width: 80%; margin-left: 10%;">
              <li class="nav-item">
                <a class="nav-link <?php if($_SERVER['REQUEST_URI']=='/R-Stadium/Users') echo'active'; ?>" href="<?php echo URLROOT ;?>/Users">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                <a class="nav-link <?php if($_SERVER['REQUEST_URI']=='/R-Stadium/Bookens') echo'active'; ?>" href="<?php echo URLROOT ;?>/Bookens">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
